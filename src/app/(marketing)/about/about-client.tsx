            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {coreValues.map((value, index) => (
                <motion.div
                  ...
                  className={`bg-white p-8 rounded-2xl border border-slate-200 shadow-lg transition-all duration-300 ${
                    hoveredIndex === index ? 'border-blue-400 bg-blue-50' : ''
                  }`}
                >
                  <div className={`w-12 h-12 rounded-full ${
                    hoveredIndex === index ? 'bg-blue-600' : 'bg-blue-100'
                  } flex items-center justify-center mb-6 transition-colors duration-300`}>
                    <span className={`text-xl font-bold ${
                      hoveredIndex === index ? 'text-white' : 'text-blue-600'
                    } transition-colors duration-300`}>{index + 1}</span>
                  </div>
            ...
            >
              ...
              <div className="space-y-6">
                <div className="flex">
                  ...
                  <div className="ml-4">
                    <h3 className="font-bold text-slate-900">Analisis Kebutuhan</h3>
                    <p className="text-slate-600">Kami memulai dengan memahami kebutuhan dan tujuan bisnis Anda</p>
                  </div>
                </div>
                ...
                <div className="flex">
                  ...
                  <div className="ml-4">
                    <h3 className="font-bold text-slate-900">Solusi Kustom</h3>
                    <p className="text-slate-600">Merancang solusi yang sesuai dengan kebutuhan spesifik Anda</p>
                  </div>
                </div>
                ...
                <div className="flex">
                  ...
                  <div className="ml-4">
                    <h3 className="font-bold text-slate-900">Pengerjaan Profesional</h3>
                    <p className="text-slate-600">Tim ahli kami mengerjakan proyek dengan standar kualitas tinggi</p>
                  </div>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {teamMembers.map((member, index) => (
                <motion.div
                  ...
                  animate="visible"
                  whileHover="hover"
                  className="bg-white rounded-2xl overflow-hidden shadow-lg border border-slate-200 text-center"
                >
